...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // Hola
        if (0 === strpos($pathinfo, '/hola') && preg_match('#^/hola/(?P<variable>[^/]+?)$#x', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Curso\\HolaMundoBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'Hola'));
        }
